                            ...
                            if (result.equals("true")){
                                ...
                                continueBtn.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        System.out.println(deviceOTP);
                                        if(deviceOTP.equals(opt)){
                                                        ...
                                                        public void onResponse(String response) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (result.equals("true")){
                                                                    ...
                                                                    Toast.makeText(CodeCheckActivity.this, "Oops, can't login! please try to login again.", Toast.LENGTH_LONG).show();
                                                                }
